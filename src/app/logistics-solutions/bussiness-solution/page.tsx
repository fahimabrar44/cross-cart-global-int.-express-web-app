...
function BussinessSolution() {
  const services = [
    {
      icon: <TruckIcon className="w-8 h-8 text-[#F5C400]" strokeWidth={1.5} />,
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gray-100 rounded-lg p-8">
              <Building2
                className="w-24 h-24 text-[#12352A] mx-auto mb-4"
                strokeWidth={1}
              />
              <div className="text-center">
                <h3 className="text-xl font-semibold text-[#12352A] mb-2">
                  Enterprise Ready
                </h3>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl font-bold text-[#12352A] mb-6">
                Why Businesses Choose CrossCart Global Int Express
              </h2>
      ...
      <div className="w-full bg-[#12352A]">
        <div className="container mx-auto px-4 py-16 text-center">
          ...
          <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
            Join thousands of businesses that trust CrossCart Global Int Express for their logistics
