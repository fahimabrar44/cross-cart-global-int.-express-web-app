  ...
  const solutions = [
    {
      ...
      icon: <Users className="w-12 h-12 text-[#12352A]" strokeWidth={1.5} />,
    ...
    },
    {
      ...
      icon: <Globe className="w-12 h-12 text-[#12352A]" strokeWidth={1.5} />,
    ...
    },
    {
      ...
      icon: <Truck className="w-12 h-12 text-[#12352A]" strokeWidth={1.5} />,
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {solutions.map((solution, index) => (
              <div key={index} className="bg-white border border-gray-200 rounded-lg p-8 shadow-lg hover:shadow-xl transition-shadow">
                ...
                <h3 className="text-xl font-bold text-[#12352A] mb-4 text-center">{solution.title}</h3>
                ...
                <div className="text-center">
                  <Link href={solution.link}>
                    <button className="bg-[#12352A] text-white py-3 px-6 rounded-lg hover:bg-[#1c4a36] transition-colors font-semibold">
                      Learn More
                    </button>
                  </Link>
                </div>
      ...
      <div className="w-full bg-[#12352A]">
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-white mb-4">Why Choose CrossCart Global Int Express Logistics?</h2>
