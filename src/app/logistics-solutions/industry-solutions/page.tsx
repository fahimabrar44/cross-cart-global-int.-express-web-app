...
export const metadata = pageMetadata({
  ...
  description:
    "Industry-specific logistics from Cross Cart Global International Express — tailored international courier and freight for garments, pharma, manufacturing and retail in Bangladesh via FedEx, DHL, UPS and Aramex.",
  path: "/logistics-solutions/industry-solutions",
  keywords: [
    "industry logistics",
    "garment shipping",
    "pharma logistics",
    "retail fulfillment",
    "manufacturing shipping Bangladesh",
  ],
});
...
const IndustrySolutions = () => {
  const industries = [
    {
      icon: <Heart className="w-10 h-10 text-[#12352A]" strokeWidth={1.5} />,
    ...
    {
      icon: <Car className="w-10 h-10 text-[#12352A]" strokeWidth={1.5} />,
    ...
    {
      icon: <Laptop className="w-10 h-10 text-[#12352A]" strokeWidth={1.5} />,
    ...
    {
      icon: <ShirtIcon className="w-10 h-10 text-[#12352A]" strokeWidth={1.5} />,
    ...
    {
      icon: <Factory className="w-10 h-10 text-[#12352A]" strokeWidth={1.5} />,
      title: "Manufacturing",
    ...
    {
      icon: <Pill className="w-10 h-10 text-[#12352A]" strokeWidth={1.5} />,
  ...
  return (
    <div className="w-full h-auto bg-soft-green overflow-x-hidden">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {industries.map((industry, index) => (
              <div key={index} className={`bg-white border-l-4 ${industry.color} rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow`}>
                ...
                <h3 className="text-xl font-bold text-[#12352A] mb-3">{industry.title}</h3>
                ...
                <Link href={"/"} className="flex items-center text-primary hover:text-[#087F4F]">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white rounded-lg p-8 border border-border shadow-card">
              <h3 className="text-2xl font-bold text-foreground mb-6">Why Choose Our Industry Solutions?</h3>
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="bg-primary text-white rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold mr-4 mt-1">✓</div>
                  <div>
                    <h4 className="font-semibold text-foreground mb-1">Expert Knowledge</h4>
                    <p className="text-muted-foreground text-sm">Deep understanding of industry-specific requirements</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="bg-primary text-white rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold mr-4 mt-1">✓</div>
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Full regulatory compliance and documentation</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="bg-primary text-white rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold mr-4 mt-1">✓</div>
                  <div>
                    <h4 className="font-semibold text-foreground mb-1">Specialized Equipment</h4>
                    <p className="text-muted-foreground text-sm">Industry-appropriate handling and transportation</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="w-full bg-white">
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#12352A] mb-4">Industry Success Stories</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-section rounded-lg p-6">
              ...
              <h3 className="text-lg font-semibold text-[#12352A] mb-2">Electronics Growth</h3>
              <p className="text-gray-600 text-sm mb-4">
            ...
            <div className="bg-section rounded-lg p-6">
              ...
              <h3 className="text-lg font-semibold text-[#12352A] mb-2">Automotive Efficiency</h3>
              <p className="text-gray-600 text-sm mb-4">
