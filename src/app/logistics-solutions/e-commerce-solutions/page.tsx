...
const ECommerceSolutions = () => {
  const services = [
    ...
    {
      icon: <RefreshCw className="w-8 h-8 text-[#F5C400]" strokeWidth={1.5} />,
      title: "Returns Management",
      description:
        "Streamlined return process with easy returns portal and reverse logistics",
    },
    {
      icon: <Zap className="w-8 h-8 text-[#F5C400]" strokeWidth={1.5} />,
      title: "API Integration",
      description:
        "Seamless integration with popular e-commerce platforms and marketplaces",
    },
    {
      icon: <BarChart3 className="w-8 h-8 text-[#F5C400]" strokeWidth={1.5} />,
            ...
            <div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <Link href="/ship-and-track">
                  <button className="border-2 border-[#12352A] text-[#12352A] py-3 px-6 rounded-lg hover:bg-[#12352A] hover:text-white transition-colors font-semibold">
                    Calculate Rates
                  </button>
                </Link>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              {benefits.map((benefit, index) => (
                <div key={index} className="bg-soft-green rounded-lg p-6 border border-border">
                  ...
                  <p className="text-[#12352A]">{benefit.description}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <div className="w-full bg-soft-green">
        <div className="container mx-auto px-4 py-16 text-center">
          ...
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join thousands of online retailers who trust CrossCart Global Int Express for their
          ...
          <div className="flex gap-3 flex-col justify-center align-middle items-center sm:flex-row">
            ...
            <Link href="/ship-and-track/create-shipment">
              <button className="border-2 border-primary text-primary py-3 px-8 rounded-lg hover:bg-primary hover:text-white transition-colors font-semibold">
                Create Shipment
              </button>
            </Link>
          </div>
