...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
  ...
  // @ts-expect-error  
    userRole: user?.role || "user",onView: handleViewAddress,onEdit: handleEditClick,onDelete: handleDeleteClick,onSetDefault: handleSetDefaultAddress,showUserInfo: true,
  });
              ...
              <div>
                ...
                <div className="text-muted-foreground space-y-1">
                  ...
                  <div>
                    {/* eslint-disable-next-line @typescript-eslint/ban-ts-comment */}
                    {/* @ts-expect-error */}
                    {defaultAddress.city}, {defaultAddress.state && `${defaultAddress.state}, `} {defaultAddress.country.name}
                  </div>
                    {/* eslint-disable-next-line @typescript-eslint/ban-ts-comment */}
                    {/* @ts-expect-error */}
