...
export default function AddressBookPage() {
  ...
  const [selectedAddress, setSelectedAddress] = useState<null>(null);
              ...
              {selectedAddress.contactPerson && (
                <div>
                  ...
                  <div className="space-y-1 text-muted-foreground">
                    ...
                    {/* eslint-disable-next-line @typescript-eslint/ban-ts-comment */}
                    {/* @ts-expect-error */}
                    {selectedAddress.contactPerson?.email && (<div><strong>Email:</strong> {selectedAddress.contactPerson?.email}</div> )}
                  </div>
                </div>
              )}
