...
{/*eslint-disable-next-line @typescript-eslint/no-explicit-any*/}
  ...
  const handleToggleStatus = async (country: Country) => {
    try {
      const response = await countryService.toggleCountryStatus(
        country._id,
        !country.isActive
      );
  ...
  return (
    <div className="space-y-6" data-testid="countries-page">
      ...
      {(user.role === "admin" || user.role === "moderator") && stats && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold" data-testid="total-countries">
                {stats.total}
              </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h3
                    ...
                    data-testid="view-country-name"
                  >
                    {selectedCountry.name}
                  </h3>
                  <p
                    className="text-muted-foreground"
                    data-testid="view-country-code"
                  >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p data-testid="view-country-currency">
                ...
                <div>
                  ...
                  <Badge
                    variant={selectedCountry.isActive ? "default" : "secondary"}
                  >
      ...
      <AlertDialog open={isDeleteModalOpen} onOpenChange={setIsDeleteModalOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle data-testid="delete-country-modal-title">
              Delete Country
            </AlertDialogTitle>
            <AlertDialogDescription>
              Are you sure you want to delete this country? This action cannot
              be undone. All related shipping routes and price configurations
              will be affected.
              {selectedCountry && (
          ...
          <AlertDialogFooter>
            <AlertDialogCancel data-testid="cancel-delete-country-btn">
              Cancel
            </AlertDialogCancel>
            <AlertDialogAction
