...
const priceCategorySchema = new Schema<IPriceCategory>(
  {
    gm500: { type: Number, default: 0 },
    gm1000: { type: Number, default: 0 },
    gm1500: { type: Number, default: 0 },
    gm2000: { type: Number, default: 0 },
    gm2500: { type: Number, default: 0 },
    gm3000: { type: Number, default: 0 },
    gm3500: { type: Number, default: 0 },
    gm4000: { type: Number, default: 0 },
    gm4500: { type: Number, default: 0 },
    gm5000: { type: Number, default: 0 },
    gm5500: { type: Number, default: 0 },
    kg6to10: { type: Number, default: 0 },
    kg11to20: { type: Number, default: 0 },
    kg21to30: { type: Number, default: 0 },
    kg31to40: { type: Number, default: 0 },
    kg41to50: { type: Number, default: 0 },
    kg51to80: { type: Number, default: 0 },
    kg81to100: { type: Number, default: 0 },
    kg101to500: { type: Number, default: 0 },
    kg501to1000: { type: Number, default: 0 },
  },
  { _id: false }
);
