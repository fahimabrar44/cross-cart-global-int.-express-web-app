...
export const PHONE_COUNTRIES: PhoneCountry[] = [
  { iso: "BD", name: "Bangladesh", dialCode: "880", min: 10, max: 10, example: "01XXXXXXXXX" },
  { iso: "IN", name: "India", dialCode: "91", min: 10, max: 10, example: "9XXXXXXXXX" },
  { iso: "PK", name: "Pakistan", dialCode: "92", min: 10, max: 10, example: "03XXYYYYYYY" },
  { iso: "NP", name: "Nepal", dialCode: "977", min: 10, max: 10, example: "98XXXXXXXX" },
  { iso: "LK", name: "Sri Lanka", dialCode: "94", min: 9, max: 9, example: "07XYYYYYYY" },
  ...
  { iso: "GB", name: "United Kingdom", dialCode: "44", min: 10, max: 10, example: "07XXXYYYYYY" },
  { iso: "AU", name: "Australia", dialCode: "61", min: 9, max: 9, example: "4XXYYYXXXX" },
  ...
  { iso: "TH", name: "Thailand", dialCode: "66", min: 9, max: 9, example: "08XYYYYYYY" },
  ...
  { iso: "NG", name: "Nigeria", dialCode: "234", min: 10, max: 10, example: "08XXXXXXXX" },
  { iso: "KE", name: "Kenya", dialCode: "254", min: 9, max: 9, example: "07XXXXXXXX" },
  { iso: "ZA", name: "South Africa", dialCode: "27", min: 9, max: 9, example: "07XXXXXXXX" },
  { iso: "MA", name: "Morocco", dialCode: "212", min: 9, max: 9, example: "6XXXXXXXX" },
  { iso: "GH", name: "Ghana", dialCode: "233", min: 9, max: 9, example: "02XXXXXXX" },
