      ...
      <div className="container py-20 m-auto">
        ...
        <div className="w-full h-auto grid grid-cols-1 md:grid-cols-2 gap-4 items-center align-middle justify-center mt-14">
          ...
          <div className="w-full h-auto p-6">
            ...
            <br />
            <p className="font-medium text-base">
              By partnering with world-renowned courier services such as DHL,
              FedEx, Aramex, UPS, along with selected local providers, we
              created a unique network that allows us to deliver the same
