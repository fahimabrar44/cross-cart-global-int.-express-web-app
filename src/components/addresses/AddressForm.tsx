...
export function AddressForm({ address, onSubmit, onCancel, loading = false }: AddressFormProps) {
  ...
  return (
    <Form {...form}>{/* eslint-disable-next-line @typescript-eslint/ban-ts-comment */}
                    {/* @ts-expect-error */}
  ...
  // @ts-expect-error  
            ...
            <div className="space-y-3">
              <FormField
                  // eslint-disable-next-line @typescript-eslint/ban-ts-comment
  // @ts-expect-error  
               control={form.control} name="address.street" render={({ field }) => (
                <FormItem>
              ...
              <FormField 
                  // eslint-disable-next-line @typescript-eslint/ban-ts-comment
  // @ts-expect-error  
              control={form.control} name="address.area" render={({ field }) => (
                <FormItem>
              ...
              <FormField 
                  ...
                  // eslint-disable-next-line @typescript-eslint/ban-ts-comment
  // @ts-expect-error  
              control={form.control} name="address.subCity" render={({ field }) => (
                <FormItem>
              ...
              <FormField 
                  ...
                  // eslint-disable-next-line @typescript-eslint/ban-ts-comment
  // @ts-expect-error  
              control={form.control} name="address.city" render={({ field }) => (
                <FormItem>
              ...
              <FormField 
                  ...
                  // eslint-disable-next-line @typescript-eslint/ban-ts-comment
  // @ts-expect-error  
              control={form.control} name="address.state" render={({ field }) => (
                <FormItem>
              ...
              <FormField 
                  ...
                  // eslint-disable-next-line @typescript-eslint/ban-ts-comment
  // @ts-expect-error  
              control={form.control} name="address.zipCode" render={({ field }) => (
                <FormItem>
              ...
              <FormField 
                  ...
                  // eslint-disable-next-line @typescript-eslint/ban-ts-comment
  // @ts-expect-error  
              control={form.control} name="address.country" render={({ field }) => (
                <FormItem>
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <FormField 
                  ...
                  // eslint-disable-next-line @typescript-eslint/ban-ts-comment
  // @ts-expect-error  
                control={form.control} name="contactPerson.name" render={({ field }) => (
                  <FormItem>
