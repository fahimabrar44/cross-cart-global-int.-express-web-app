...
export const SINGLE_CONTACT_API = (contactId: string) =>
  `${ROOT_API}contacts/${contactId}`;

// Notification endpoints
export const NOTIFICATION_API = `${ROOT_API}notifications/`;
export const SINGLE_NOTIFICATION_API = (notificationId: string) =>
  `${ROOT_API}notifications/${notificationId}`;

// Offer endpoints
export const OFFER_API = `${ROOT_API}offers/`;
export const SINGLE_OFFER_API = (offerId: string) =>
  `${ROOT_API}offers/${offerId}`;

// Pickup endpoints
export const PICKUP_API = `${ROOT_API}pickups/`;
export const SINGLE_PICKUP_API = (pickupId: string) =>
  `${ROOT_API}pickups/${pickupId}`;

// Price endpoints
export const PRICE_API = `${ROOT_API}prices/`;
export const SINGLE_PRICE_API = (priceId: string) =>
  `${ROOT_API}prices/${priceId}`;

// Review endpoints
export const REVIEW_API = `${ROOT_API}reviews/`;
export const SINGLE_REVIEW_API = (reviewId: string) =>
  `${ROOT_API}reviews/${reviewId}`;
