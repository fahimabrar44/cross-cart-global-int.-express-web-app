...
export function DashboardOverview() {
  ...
  // @ts-expect-error  
  const userGrowth =  analytics?.signupTrend?.length || 0 > 1 ? (analytics.signupTrend[analytics.signupTrend.length - 1]?.count || 0) - (analytics.signupTrend[analytics.signupTrend.length - 2]?.count || 0)
      : 0;
