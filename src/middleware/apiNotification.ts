...
export class ApiNotificationMiddleware {
  ...
  private static async sendActivityNotification(data: ApiActivityData): Promise<void> {
    ...
    if (endpoint.includes("/orders")) {
      ...
      if (success) {
        ...
        message = "Welcome to CrossCart Global Int Express! Please verify your email address";
        type = "success";
      }
  ...
  private static async sendActivityEmail(data: ApiActivityData): Promise<void> {
    ...
    let subject = "CrossCart Global Int Express Account Activity";
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    if (endpoint.includes("/auth/signin")) {
      if (success) {
        subject = "Successful Login - CrossCart Global Int Express Account";
        emailData = {
          ...emailData,
          title: "Login Alert",
          message: `Your CrossCart Global Int Express account was accessed successfully from IP address ${data.ipAddress}`,
          actionText: "View Account",
          actionUrl: `${process.env.PUBLIC_APP_URL}/dashboard`,
        };
      } else {
        subject = "Failed Login Attempt - CrossCart Global Int Express Account";
        emailData = {
          ...emailData,
          title: "Security Alert",
          message: `A failed login attempt was made on your CrossCart Global Int Express account from IP address ${data.ipAddress}`,
      ...
      emailData = {
        ...emailData,
        title: "Welcome to CrossCart Global Int Express!",
      ...
      subject = "New Order Confirmation - CrossCart Global Int Express";
      ...
      subject = "Pickup Scheduled - CrossCart Global Int Express";
